        ...
        >
          <Box sx={style}>
            <Grid container spacing={2} align="center">
              ...
              {addCatSub ? <>
                <Grid item xs={12} md={6}>
                  <Typography id="modal-modal-title" variant="h6" component="h2" fontWeight="light">
                    Name
                  </Typography>
                </Grid>
                <Grid item xs={12} md={6}>
              ...
              <Grid item xs={12} md={12}>
                <TableContainer >
                  <Table aria-label="simple table">
                    {/* <TableHead> */}
                    <TableRow>
                      <TableCell style={{ fontWeight: 100, color: 'white' }}>Sub Category name</TableCell>
                      <TableCell style={{ fontWeight: 100, color: 'white' }}>Actions</TableCell>
                    </TableRow>
                    {/* </TableHead> */}
                    <TableBody>
                      {allSubCat.map((row) => (
